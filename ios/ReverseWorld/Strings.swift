...
enum L10n {
    ...
    static let profilePremiumUnlock = "Unlock Premium — Subscription"
    ...
    // Paywall
    static let paywallTitle = "Unlock Premium — Subscription"
    static let paywallSubtitleFormat = "Auto-Renewable Subscription. 7-day free trial, then %@/month"
    static let paywallYearly = "Yearly (Auto-Renew)"
    static let paywallYearlyFormat = "Best value • %@/year, auto-renews"
    static let paywallYearlyFallback = "Best value • $49.99/year, auto-renews"
    static let paywallMonthly = "Monthly (Auto-Renew)"
    static let paywallMonthlyFormat = "%@/month, auto-renews"
    static let paywallMonthlyFallback = "$4.99/month, auto-renews"
